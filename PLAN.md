...
**DoD**: 24시간 무중단 실행, drop_count = 0, Argus 자체 CPU 평균 1.5% 미만, DB 증가량 하루 500MB 미만.
...
> ⚠️ **24시간 무중단 검증은 아직 하지 않았다.** 300초 관측만으로 24시간을 보장할 수 없다
> (느린 누수·보존 정리 동작·WAL 성장은 장시간에만 드러난다). Phase 2 착수 전 하루 돌려 확인할 것.
>
