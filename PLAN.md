...
| 3 | **알람 품질** (2026-07-28 삽입) | 실측 21시간에서 신호 6건 중 4건이 한 룰(GPU 온도)이었고 전부 critical 이었다. **오탐을 줄이기 전에 탐지기를 더 얹으면 사건만 늘고 품질은 안 오른다** — Phase 6 이 이길 상대가 가짜가 된다 | Phase 6 의 스코어보드가 의미를 갖는다 |
